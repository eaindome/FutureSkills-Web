<script lang="ts">
  ...
  export let variant: "primary" | "secondary" | "outline" | "accent" = "primary";
...
<button
  {type}
  class="{variantClass} {widthClass} flex justify-center items-center py-2 px-4 border rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 transition-all duration-300 ease-in-out mt-2 transform hover:scale-105 active:scale-95 hover:shadow-md"
