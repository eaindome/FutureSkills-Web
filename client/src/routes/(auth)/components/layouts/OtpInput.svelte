...
<svelte:head>
    <title>VerifyEmail | FutureSkills Coach</title>
    ...
    >
            ...
            {#each otp as digit, i}
                <div class="relative">
                    <input
                        ...
                        } focus:ring-2 focus:ring-[#2E7D32] focus:border-[#2E7D32] focus:scale-105"
                    />
        ...
        <div class="mt-4 flex justify-between items-center">
            ...
            <button 
                type="button" 
                on:click={reset}
                class="text-xs text-[#2E7D32] hover:text-[#1b4b1f] focus:outline-none {isComplete || otp.some(d => d !== '') ? '' : 'opacity-50 cursor-default'}"
