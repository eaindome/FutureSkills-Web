...
<svelte:head>
  <title>SignUp | FutureSkills Coach</title>
  <meta name="description" content="Create an account to access personalized career guidance for sustainable jobs and skills development">
</svelte:head>

<AuthLayout title="Create your account" subtitle="Start your journey toward sustainable skills">
  {#if error}
  ...
  <form on:submit|preventDefault={handleSubmit} class="space-y-5">
    ...
    <div class="flex items-center">
      ...
      <label for="agree-terms" class="ml-2 block text-sm text-gray-700">
        I agree to the <a href="/terms" class="text-green-600 hover:underline">Terms of Service</a> and <a href="/privacy" class="text-green-600 hover:underline">Privacy Policy</a>
      </label>
    </div>
    ...
    <div class="text-center">
      <p class="text-sm text-gray-600">
        ...
        <a href="/login" class="font-medium text-blue-500 hover:underline">
          Sign in
        </a>
      </p>
    </div>
